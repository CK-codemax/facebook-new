...
export default function StoryCard({ src, profile, name}) {
  return (
    <div className="relative h-32 min-w-20 sm:h-56 sm:min-w-32 cursor-pointer p-3">
       ...
       <Image src={src} alt="feed-image" layout="fill" className="object-cover w-full h-full filter brightness-75 rounded-xl sm:rounded-3xl" />
       {/* <Image  style={{
              maxWidth: "100%",
              height: "auto",
            }} src={src} alt="feed-image" width={500} height={500} className="object-cover w-full h-full filter brightness-75 rounded-xl sm:rounded-3xl" /> */}
