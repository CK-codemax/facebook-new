  ...
  return (
    ...
    <form className="flex flex-col space-y-3 w-[85%] sm:w-[450px] items-center justify-center">
       <div className="flex flex-col w-full items-start justify-start space-y-1">
           ...
           <input disabled className="border border-gray-700 w-full p-2 px-4 rounded-md text-black placeholder:text-gray-500 outline-blue-500" id="email" placeholder="Enter your email" type="text" />
       </div>
       ...
       <div className="flex flex-col items-start justify-start  space-y-1 w-full">
           ...
           <input disabled className="border border-gray-700 w-full p-2 px-4 rounded-md text-black placeholder:text-gray-500 outline-blue-500" id="email" placeholder="Enter your password" type="text" />
       </div>
