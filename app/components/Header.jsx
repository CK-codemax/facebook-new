    ...
    <header className="sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md">
        ...
        <div className="flex items-center sm:space-x-2 justify-end">
            ...
            <FaBell className="reactIcon" />
             ...
             <WidgetsModal>
                 <WidgetsModal.Open>
                    <IoChevronDownCircleOutline className='text-[20px] lg:hidden mr-2 text-gray-600'  />
                 </WidgetsModal.Open>
             ...
             <Image onClick={() => signOut({callbackUrl : '/'})} className="rounded-full cursor-pointer object-cover w-[44px] h-[44px]" src={session?.user?.image} alt="profile-image" width={40} height={40} placeholder="blur" blurDataURL="/facebook-user.png"/>
